...
ManualRestart.set();
// TODO: похоже тут загружаем конфиг приложения из локал стораджа - проверить так ли это
UpdateConfig.loadFromLocalStorage();

// TODO: Спрятал какую то кнопку конфигурация API - Удалить
...
Focus.set(true, true);
$(document).ready(() => {
  // TODO: Спрятал инфу про мерч - Удалить
  // CookiePopup.check();
